...
def register(bot):
    ...
    def admin_panel(msg: Message):
        ...
        bot.send_message(chat_id, message, reply_markup=admin_keyboard(), parse_mode="Markdown")
    ...
    def show_stats(call: CallbackQuery):
        ...
        if published_posts:
            ...
            recent_posts = [
                ...
                if p.get("publish_date") and datetime.fromisoformat(p["publish_date"].replace("Z", "+00:00")) > week_ago
            ]
