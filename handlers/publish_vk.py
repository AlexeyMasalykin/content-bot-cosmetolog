...
from utils.tg_utils import truncate_caption, clean_markdown, smart_vk_text
from utils.vk_utils import vk_publish_text, vk_publish_photo_and_text, vk_post_url, vk_publish_with_image_required
import logging
...
def register(bot):
    ...
    def publish_vk_photo(call: CallbackQuery):
        ...
        try:
            ...
            post_id = vk_publish_with_image_required(
                VK_GROUP_ID,
                draft["image_bytes"],
                smart_vk_text(draft["text"])
            )
